...
\chapter{Le public cible}
Le site s'adresse au grand public, avec les clasique de la litérature mais aussi
les nouvelle sorti. Le site doit disposser d'un large fois de libre en stock et
doit donc être relier à un système de gestions de stock car le large choix enpèche
de stocker de grande quantité de livre. Il faut donc renouveller les stocks
régulièrement en fonction des besions.
