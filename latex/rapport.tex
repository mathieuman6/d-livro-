...
Il faut pouvoir synchroniser le site de e-commerce avec un systeme de gestion
...
\item[\textcolor{orange}{Fort} - ] Un site soit ergonomique et accessible sur toutes les plateformes
\item[\textcolor{green}{Faible} - ] Un design épuré et simple d'accès et épuré
...
\item[\textcolor{orange}{Obligatoire} - ] Un formulaire avec les données personnel les adresses de livraison
...
\item[\textcolor{red}{Obligatoire} - ] Le site doit être hébergé sur un serveur pour qu'on y avoir accès en ligne
\item[\textcolor{red}{Obligatoire} - ] Un nom de domaine
\item[\textcolor{red}{Obligatoire} - ] Une équipe de développeur pour que le site soit accessible pour avril
